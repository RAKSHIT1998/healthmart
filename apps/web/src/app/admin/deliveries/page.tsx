...
import { SignaturePad } from '@/components/admin/delivery/signature-pad';
import { formatCurrency } from '@/lib/utils';

const DestinationMap = dynamic(() => import('@/components/admin/delivery/destination-map').then((m) => m.DestinationMap), {
  ssr: false,
...
} from '@/hooks/admin/use-deliveries';
